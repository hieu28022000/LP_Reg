...
from libs.DeepText.modules.transformation import TPS_SpatialTransformerNetwork
from libs.DeepText.modules.feature_extraction import VGG_FeatureExtractor, RCNN_FeatureExtractor, ResNet_FeatureExtractor
from libs.DeepText.modules.sequence_modeling import BidirectionalLSTM
from libs.DeepText.modules.prediction import Attention
...
class Model(nn.Module):
    ...
    def __init__(self, num_class):
        ...
        if FeatureExtraction == 'VGG':
            ...
            self.FeatureExtraction = RCNN_FeatureExtractor(1, 512)
